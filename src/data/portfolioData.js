...
export const experience = [
  {
    ...
    certificate: 'https://drive.google.com/file/d/12dB553CvpvBkER4uTLWH0fKPiKhWgqxe/view?usp=drive_link',
  },
  {
    id: 2,
    ...
    certificate: 'https://drive.google.com/file/d/1LvfjsRakW226BBOp1xn7aruP-VkhmEYV/view?usp=drive_link',
  },
  {
    id: 3,
...
export const projects = [
  ...
  },
  {
    ...
    github: 'https://github.com/Gokul-64/Find-IT',
    live: '#',
    emoji: '✈️',
    color: '#1a73e8',
    category: 'AI',
  },
  {
    ...
    github: 'https://github.com/Gokul-64/Railway_Reservation_System',
    live: '#',
    emoji: '🚂',
    color: '#fbbc04',
    category: 'Java',
  },
  {
    ...
    tech: ['Java', 'MySQL', 'JDBC', 'Swing'],
    github: 'https://github.com/Gokul-64/Library_Management_System',
    live: '#',
    emoji: '📚',
    color: '#34a853',
    category: 'Java',
...
export const achievements = [
  {
    ...
    description: 'Academic excellence at Dr.Mahalingam College of Engineering and Technology, Pollachi (2022–2023)',
    icon: '🏆',
    color: '#fbbc04',
  },
  {
